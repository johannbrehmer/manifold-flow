...
class PowerManifoldSimulator(BaseSimulator):
    def __init__(self, draw_constants=False, max_power=10, power_decay=1.0, const_width=2.0, min_width=0.1, max_width=1.0, filename=None):
    ...
    def distance_from_manifold(self, x):
        z, z_eps = self._transform_x_to_z(x)
