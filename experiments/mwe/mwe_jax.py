...
sys.path.append(".")
from utils_jax import batch_jacobian, sum_except_batch, ResidualNet
...
class AffineCouplingTransform():
    ...
    def forward(self, inputs, context=None, full_jacobian=False):
        ...
        transform_params = self.transform_net.forward(identity_split, context)
