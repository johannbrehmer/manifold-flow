...
python -u train.py --modelname march --dataset lhc --algorithm gamf --modellatentdim 14 -i ${SLURM_ARRAY_TASK_ID}
python -u train.py --modelname alternate_march --dataset lhc --algorithm gamf --modellatentdim 14 -i ${SLURM_ARRAY_TASK_ID}
