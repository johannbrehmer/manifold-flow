...
python -u evaluate.py --modelname alternate_april --dataset lhc --algorithm emf --modellatentdim 14 --observedsamples 50 --splinebins 10 -i $run --skiplikelihood --burnin 50 --mcmcsamples 500 --trueparam $true --chain $chain --dir $dir
