...
6) python -u evaluate.py --modelname small_shallow_long --dataset conditional_spherical_gaussian --algorithm mf --epsilon 0.01 --outerlayers 3 --innerlayers 3 --dir /scratch/jb6504/manifold-flow ;;
7) python -u evaluate.py --modelname small_shallow_long --dataset conditional_spherical_gaussian --algorithm mf --epsilon 0.001 --outerlayers 3 --innerlayers 3 --dir /scratch/jb6504/manifold-flow ;;
8) python -u evaluate.py --modelname small_shallow_long --dataset conditional_spherical_gaussian --algorithm mf --epsilon 0.1 --outerlayers 3 --innerlayers 3 --dir /scratch/jb6504/manifold-flow ;;

9) python -u evaluate.py --modelname small_long --dataset conditional_spherical_gaussian --algorithm mf --epsilon 0.01 --dir /scratch/jb6504/manifold-flow ;;
