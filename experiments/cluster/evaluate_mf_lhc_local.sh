...
do
    ...
    do
        ...
        do
            ...
            python -u evaluate.py -c configs/evaluate_mf_lhc_june.config -i $run --trueparam $param --chain $chain
...
do
    ...
    do
        ...
        do
            ...
            python -u evaluate.py -c configs/evaluate_mf_lhc_june.config --modelname scandal_june -i $run --trueparam $param --chain $chain
