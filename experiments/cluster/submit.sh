...
#sbatch --array 0-2 evaluate_gamf_spherical.sh
#sbatch --array 0-2 evaluate_mf_spherical.sh
...
#sbatch --array 0-2 evaluate_gamf_csg.sh
#sbatch --array 0-2 evaluate_mf_csg.sh
