...
# sbatch evaluate_gamf_spherical.sh  # not yet trained
...
# sbatch evaluate_flow_csg.sh  # some not yet trained
# sbatch evaluate_pie_csg.sh  # some not yet trained
# sbatch evaluate_gamf_csg.sh  # not yet trained
...
# sbatch evaluate_flow_tth2d.sh  # not yet trained
# sbatch evaluate_flow_tth.sh  # not yet done
# sbatch evaluate_pie_tth.sh  # not yet done
# sbatch evaluate_gamf_tth.sh  # not yet trained
