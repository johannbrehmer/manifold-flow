...
#sbatch --array=0-15 train_mf_spherical.sh
...
#sbatch --array=0-16 train_mf_csg.sh
...
sbatch --array 0-8 evaluate_gamf_spherical.sh
...
sbatch --array 0-8 evaluate_gamf_csg.sh
