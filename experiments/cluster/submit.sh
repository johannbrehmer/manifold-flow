...
sbatch --array 0-2 evaluate_flow_spherical.sh
sbatch --array 0-2 evaluate_pie_spherical.sh
sbatch --array 0-35 evaluate_gamf_spherical.sh
sbatch --array 0-80 evaluate_mf_spherical.sh
