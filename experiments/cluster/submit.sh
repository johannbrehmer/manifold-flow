...
#sbatch --array 1-2 evaluate_gamf_spherical.sh
#sbatch --array 1-2 evaluate_mf_spherical.sh
#sbatch --array 1-2 evaluate_emf_spherical.sh
...
#sbatch --array 1-2 evaluate_gamf_csg.sh
#sbatch --array 1-2 evaluate_mf_csg.sh
#sbatch --array 1-2 evaluate_emf_csg.sh
...
#sbatch --array 1-2 evaluate_gamf_lhc.sh
