...
sbatch --array 0-0 evaluate_flow_spherical.sh
sbatch --array 0-0 evaluate_pie_spherical.sh
sbatch --array 0-11 evaluate_gamf_spherical.sh
sbatch --array 0-26 evaluate_mf_spherical.sh
sbatch --array 0-2 evaluate_emf_spherical.sh
sbatch --array 0-0 evaluate_spie_spherical.sh
sbatch --array 0-0 evaluate_smf_spherical.sh
sbatch --array 0-0 evaluate_sgamf_spherical.sh
sbatch --array 0-0 evaluate_pie_epsilon_spherical.sh

sbatch --array 0-0 evaluate_flow_csg.sh
sbatch --array 0-0 evaluate_pie_csg.sh
sbatch --array 0-11 evaluate_gamf_csg.sh
sbatch --array 0-26 evaluate_mf_csg.sh
sbatch --array 0-2 evaluate_emf_csg.sh
sbatch --array 0-0 evaluate_spie_csg.sh
sbatch --array 0-0 evaluate_smf_csg.sh
sbatch --array 0-0 evaluate_sgamf_csg.sh
sbatch --array 0-0 evaluate_pie_epsilon_csg.sh

sbatch --array 0-0 evaluate_flow_lhc2d.sh
sbatch --array 0-0 evaluate_flow_lhc.sh
sbatch --array 0-0 evaluate_pie_lhc.sh
sbatch --array 0-1 evaluate_gamf_lhc.sh
