...
# sbatch evaluate_mf_spherical.sh  # STILL MISSING
# sbatch evaluate_flow_csg.sh  # STILL MISSING
# sbatch evaluate_pie_csg.sh  # STILL MISSING
# sbatch evaluate_mf_csg.sh  # STILL MISSING
# sbatch evaluate_opie_csg.sh  # STILL MISSING
# sbatch evaluate_omf_csg.sh  # STILL MISSING
