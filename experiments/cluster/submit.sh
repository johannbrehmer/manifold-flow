...
sbatch --array 9-11 evaluate_mf_csg.sh
sbatch --array 21-22 evaluate_mf_csg.sh
sbatch --array 48-49 evaluate_mf_csg.sh
sbatch --array 75-76 evaluate_mf_csg.sh
#sbatch --array 0-8 evaluate_emf_csg.sh
