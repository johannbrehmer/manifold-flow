...
python -u train.py --modelname alternate_april_long --load mf_14_lhc_alternate_april --lr 1.e-5 --dataset lhc --algorithm mf --alternate --modellatentdim 14 --splinebins 10 --nllfactor 0.1 --subsets 100 -i ${SLURM_ARRAY_TASK_ID}
