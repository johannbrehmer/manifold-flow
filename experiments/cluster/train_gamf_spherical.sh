...
python -u train.py --modelname debug --dataset spherical_gaussian --algorithm gamf --specified --epsilon 0.001 --genbatchsize 100 --samplesize 100000 --dir /scratch/jb6504/manifold-flow
python -u train.py --modelname debug_largebs --dataset spherical_gaussian --algorithm gamf --specified --epsilon 0.001 --genbatchsize 1000 --samplesize 100000 --dir /scratch/jb6504/manifold-flow
