...
python -u train.py --modelname small_ged_largebs_shallow_long --dataset spherical_gaussian --algorithm gamf --ged --epsilon 0.01 --samplesize 100000 --genbatchsize 2000 --epochs 1000 --outerlayers 3 --innerlayers 3 --dir /scratch/jb6504/manifold-flow
python -u train.py --modelname small_ged_largebs_shallow_long --dataset spherical_gaussian --algorithm gamf --ged --epsilon 0.001 --samplesize 100000 --genbatchsize 2000 --epochs 1000 --outerlayers 3 --innerlayers 3 --dir /scratch/jb6504/manifold-flow
python -u train.py --modelname small_ged_largebs_shallow_long --dataset spherical_gaussian --algorithm gamf --ged --epsilon 0.1 --samplesize 100000 --genbatchsize 2000 --epochs 1000 --outerlayers 3 --innerlayers 3 --dir /scratch/jb6504/manifold-flow

python -u train.py --modelname small_ged_largebs_long --dataset spherical_gaussian --algorithm gamf --ged --epsilon 0.01 --samplesize 100000 --genbatchsize 2000 --epochs 1000 --dir /scratch/jb6504/manifold-flow
python -u train.py --modelname small_ged_largebs_long --dataset spherical_gaussian --algorithm gamf --ged --epsilon 0.001 --samplesize 100000 --genbatchsize 2000 --epochs 1000 --dir /scratch/jb6504/manifold-flow
python -u train.py --modelname small_ged_largebs_long --dataset spherical_gaussian --algorithm gamf --ged --epsilon 0.1 --samplesize 100000 --genbatchsize 2000 --epochs 1000 --dir /scratch/jb6504/manifold-flow
