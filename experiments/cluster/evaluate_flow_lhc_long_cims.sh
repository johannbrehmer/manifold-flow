...
python -u evaluate.py --modelname april_long --dataset lhc --algorithm flow --modellatentdim 14 --observedsamples 50 --splinebins 10 -i $run --skiplikelihood --burnin 50 --mcmcsamples 500 --trueparam $true --chain $chain --dir $dir
