...
#SBATCH --job-name=e-mfs-l
#SBATCH --output=log_evaluate_mf_lhc_scandal_%a.log
#SBATCH --nodes=1
...
python -u evaluate.py -c configs/evaluate_mf_lhc_june.config --modelname scandal_june -i $run --trueparam $true --chain $chain
