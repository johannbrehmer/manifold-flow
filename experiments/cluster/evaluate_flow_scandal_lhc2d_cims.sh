...
python -u evaluate.py -c cluster/configs/evaluate_lhc_may.config --dataset lhc2d --modellatentdim 2 --modelname scandal_may --algorithm flow -i $run --trueparam $true --chain $chain --dir $dir
