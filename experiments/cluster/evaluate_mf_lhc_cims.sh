...
cd $dir/experiments
python -u evaluate.py --modelname alternate_april --dataset lhc --algorithm mf --modellatentdim 14 --splinebins 10 --observedsamples 50 -i ${run} --skiplikelihood --burnin 50 --mcmcsamples 400 --chain $chain  --dir $dir
