...
case ${task} in
0) python -u train.py --modelname small --dataset power --algorithm emf --outercouplingmlp --outercouplinglayers 1 --samplesize 100000 -i ${run} --dir /scratch/jb6504/manifold-flow ;;
