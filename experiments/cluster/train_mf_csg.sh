...
0) python -u train.py --dataset conditional_spherical_gaussian --algorithm mf --outercouplingmlp --outercouplinglayers 1 --outercouplinghidden 100 --datadim 9 --epsilon 0.01 --dir /scratch/jb6504/manifold-flow ;;
