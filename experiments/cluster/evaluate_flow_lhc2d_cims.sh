...
python -u evaluate.py -c configs/evaluate_lhc_may.config --dataset lhc2d --modellatentdim 2 --modelname may --algorithm flow -i $run --trueparam $true --chain $chain --dir $dir
