...
# python -u train.py --modelname alternate_april_long --load mf_14_lhc40d_alternate_april --lr 1.e-4 --dataset lhc40d --algorithm mf --alternate --modellatentdim 14 --splinebins 10 --nllfactor 0.1 --subsets 100 -i ${SLURM_ARRAY_TASK_ID}
