...
python -u evaluate.py -c cluster/configs/evaluate_lhc_may.config --modelname sequential_scandal_may --algorithm emf -i $run --trueparam $true --chain $chain --dir $dir
