...
python -u train.py --modelname reg0001 --dataset spherical_gaussian --algorithm pie --epsilon 0.01 --l2reg 0.001 --dir /scratch/jb6504/manifold-flow
python -u train.py --modelname reg001 --dataset spherical_gaussian --algorithm pie --epsilon 0.01 --l2reg 0.01 --dir /scratch/jb6504/manifold-flow
python -u train.py --modelname reg01 --dataset spherical_gaussian --algorithm pie --epsilon 0.01 --l2reg 0.1 --dir /scratch/jb6504/manifold-flow
python -u train.py --modelname reg1 --dataset spherical_gaussian --algorithm pie --epsilon 0.01 --l2reg 1.0 --dir /scratch/jb6504/manifold-flow
