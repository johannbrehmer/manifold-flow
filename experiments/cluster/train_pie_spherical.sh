...
python -u train.py --modelname small_shallow_long --dataset spherical_gaussian --algorithm pie --epsilon 0.01 --samplesize 100000 --epochs 50 --outerlayers 3 --innerlayers 3 -i ${SLURM_ARRAY_TASK_ID} --dir /scratch/jb6504/manifold-flow
