...
#0) python -u train.py --modelname small_noprepost --dataset spherical_gaussian --epsilon 0.01 --algorithm emf --outercouplingmlp --outercouplinglayers 1 --nopretraining --noposttraining --samplesize 100000 --dir /scratch/jb6504/manifold-flow ;;
#1) python -u train.py --modelname small_noprepost --dataset spherical_gaussian --epsilon 0.001 --algorithm emf --outercouplingmlp --outercouplinglayers 1 --nopretraining --noposttraining --samplesize 100000 --dir /scratch/jb6504/manifold-flow ;;
#2) python -u train.py --modelname small_noprepost --dataset spherical_gaussian --epsilon 0.1  --algorithm emf --outercouplingmlp --outercouplinglayers 1 --nopretraining --noposttraining --samplesize 100000 --dir /scratch/jb6504/manifold-flow ;;
#
#3) python -u train.py --modelname small_complex --dataset spherical_gaussian --epsilon 0.01 --algorithm emf --samplesize 100000 --dir /scratch/jb6504/manifold-flow ;;
#4) python -u train.py --modelname small_complex --dataset spherical_gaussian --epsilon 0.001 --algorithm emf --samplesize 100000 --dir /scratch/jb6504/manifold-flow ;;
#5) python -u train.py --modelname small_complex --dataset spherical_gaussian --epsilon 0.1  --algorithm emf --samplesize 100000 --dir /scratch/jb6504/manifold-flow ;;
