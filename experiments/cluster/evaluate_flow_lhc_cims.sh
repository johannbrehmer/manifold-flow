...
cd $dir/experiments
python -u evaluate.py --modelname march --dataset lhc --algorithm flow --modellatentdim 14 --splinebins 10 --observedsamples 100 --skiplikelihood --burnin 50 --mcmcsamples 400 --chain $chain -i $run  --dir $dir
