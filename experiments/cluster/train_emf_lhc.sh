...
#SBATCH --output=log_train_emf_lhc2_%a.log
#SBATCH --nodes=1
...
python -u train.py --modelname alternate_march --dataset lhc --algorithm emf --alternate --modellatentdim 14 --splinebins 10 -i ${SLURM_ARRAY_TASK_ID}
