...
#0) python -u evaluate.py --modelname small_noprepost --dataset conditional_spherical_gaussian --epsilon 0.01 --algorithm emf --outercouplingmlp --outercouplinglayers 1 --dir /scratch/jb6504/manifold-flow ;;
#1) python -u evaluate.py --modelname small_noprepost --dataset conditional_spherical_gaussian --epsilon 0.001 --algorithm emf --outercouplingmlp --outercouplinglayers 1 --dir /scratch/jb6504/manifold-flow ;;
#2) python -u evaluate.py --modelname small_noprepost --dataset conditional_spherical_gaussian --epsilon 0.1  --algorithm emf --outercouplingmlp --outercouplinglayers 1 --dir /scratch/jb6504/manifold-flow ;;
#
#3) python -u evaluate.py --modelname small_complex --dataset conditional_spherical_gaussian --epsilon 0.01 --algorithm emf --dir /scratch/jb6504/manifold-flow ;;
#4) python -u evaluate.py --modelname small_complex --dataset conditional_spherical_gaussian --epsilon 0.001 --algorithm emf --dir /scratch/jb6504/manifold-flow ;;
#5) python -u evaluate.py --modelname small_complex --dataset conditional_spherical_gaussian --epsilon 0.1  --algorithm emf --dir /scratch/jb6504/manifold-flow ;;
#
