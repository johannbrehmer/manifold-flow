...
0) python -u evaluate.py --dataset spherical_gaussian --algorithm mf --outercouplingmlp --outercouplinglayers 1 --epsilon 0.01 --dir /scratch/jb6504/manifold-flow ;;
1) python -u evaluate.py --dataset spherical_gaussian --algorithm mf --outercouplingmlp --outercouplinglayers 1 --epsilon 0.001 --dir /scratch/jb6504/manifold-flow ;;
2) python -u evaluate.py --dataset spherical_gaussian --algorithm mf --outercouplingmlp --outercouplinglayers 1 --epsilon 0.1 --dir /scratch/jb6504/manifold-flow ;;
