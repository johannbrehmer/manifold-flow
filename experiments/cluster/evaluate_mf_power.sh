...
7) python -u evaluate.py --modelname small_alternate_wdecay --dataset power --algorithm mf --gridresolution 101 -i ${run} --dir /scratch/jb6504/manifold-flow ;;
8) python -u evaluate.py --modelname small_alternate_wdecay_shallow_long --dataset power --algorithm mf --outerlayers 3 --innerlayers 3 --gridresolution 101 -i ${run} --dir /scratch/jb6504/manifold-flow ;;
9) python -u evaluate.py --modelname small_alternate_wdecay_long --dataset power --algorithm mf --gridresolution 101 -i ${run} --dir /scratch/jb6504/manifold-flow ;;
