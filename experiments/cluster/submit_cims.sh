...
sbatch --array 84-95 evaluate_flow_scandal_lhc2d_cims.sh
...
sbatch --array 84-95 evaluate_flow_scandal_lhc40d_cims.sh
...
sbatch --array 96-107 evaluate_mfs_scandal_lhc40d_cims.sh
# sbatch --array 108-119 evaluate_mfs_scandal_lhc40d_cims.sh

# sbatch --array 0-59 evaluate_mfa_scandal_lhc40d_cims.sh
# sbatch --array 60-83 evaluate_mfa_scandal_lhc40d_cims.sh  # done
# sbatch --array 84-95 evaluate_mfa_scandal_lhc40d_cims.sh  # done
...
# sbatch --array 72-95 evaluate_emfs_scandal_lhc40d_cims.sh  # done
sbatch --array 96-107 evaluate_emfs_scandal_lhc40d_cims.sh
