...
# Run 1
# sbatch --array 0-11 evaluate_flow_lhc2d_cims.sh  # check
# sbatch --array 0-11 evaluate_flow_lhc_cims.sh  # check
# sbatch --array 0-11 evaluate_pie_lhc_cims.sh  # check
...
# Run 2-3
# sbatch --array 12-35 evaluate_flow_lhc2d_cims.sh  # check
# sbatch --array 12-35 evaluate_flow_lhc_cims.sh  # check
sbatch --array 12-35 evaluate_pie_lhc_cims.sh
# sbatch --array 12-35 evaluate_mf_lhc_cims.sh
# sbatch --array 12-23 evaluate_emf_lhc_cims.sh
sbatch --array 24-35 evaluate_emf_lhc_cims.sh
