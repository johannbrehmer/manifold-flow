...
# sbatch --array 0-11 evaluate_emf_lhc40d_cims.sh  # submitted
...
# sbatch --array 36-47 evaluate_emf_lhc40d_cims.sh  # submitted
...
# sbatch --array 48-59 evaluate_emf_lhc_cims.sh  # done
