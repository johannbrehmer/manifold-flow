...
sbatch --array 96-107 evaluate_flow_lhc2d_cims.sh
...
sbatch --array 96-107 evaluate_flow_lhc40d_cims.sh
...
sbatch --array 96-107 evaluate_pie_lhc40d_cims.sh
...
sbatch --array 96-107 evaluate_emfs_lhc40d_cims.sh
...
# sbatch --array 72-119 evaluate_emfa_lhc40d_cims.sh
