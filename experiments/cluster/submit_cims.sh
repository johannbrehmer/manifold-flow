...
# sbatch --array 0-11 evaluate_mf_lhc40d_cims.sh  # submitted
...
# sbatch --array 12-35 evaluate_mf_lhc40d_cims.sh  # submitted
...
# sbatch --array 36-59 evaluate_mf_lhc40d_cims.sh  # submitted
