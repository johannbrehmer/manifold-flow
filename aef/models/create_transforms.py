...
def _create_base_transform(i, base_transform_type, features, hidden_features, num_transform_blocks, dropout_probability, use_batch_norm, num_bins, tail_bound, apply_unconditional_transform):
...
def create_transform(dim, flow_steps, linear_transform_type='lu', base_transform_type='rq-autoregressive', hidden_features=256, num_transform_blocks=2, dropout_probability=0.25, use_batch_norm=False, num_bins=8, tail_bound=3, apply_unconditional_transform=True):
    transform = transforms.CompositeTransform([
        transforms.CompositeTransform([
            _create_linear_transform(linear_transform_type, dim),
            _create_base_transform(i, base_transform_type, dim, hidden_features, num_transform_blocks, dropout_probability, use_batch_norm, num_bins, tail_bound, apply_unconditional_transform)
